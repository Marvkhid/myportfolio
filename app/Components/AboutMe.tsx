  ...
  return (
    <Section id='about' className="bg-neutral-950 text-white">
      <Container className="lg:max-w-6xl">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-24 items-center">
          {/* Content Section */}
            ...
            <p className="text-lg md:text-xl font-semibold leading-relaxed tracking-wide">
              ...
              <br />
              <br />
              When I'm not coding, I enjoy exploring new technologies, sharing
              ideas, and learning to improve my craft. Let's connect and build
              something amazing!
            </p>
          </div>
        ...
        <p><b>Programming is a big part of my life for past 2 years.</b>
        ...
        <br />
        <br />
        but i never relented...This has made me realise that i can catch up with new things really fast.
        <br />
        <br />
        ...
        I hope to still be better as i get hoooked with more job opportunities
        Looking forward to widening my skills
        <br />
        <br />Who knows ... We could both become the next <b>BIG THING</b></p>
